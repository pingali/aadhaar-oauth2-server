...
@login_required
def download(request, client_id):
    
    print "In apps.account.views.download - entered" 
    ...
    response['Content-Disposition']='attachment; filename=client-config.json'
    return response 
